...
import com.buzbuz.gradle.convention.extensions.protobuf
...
class ProtobufConventionPlugin : Plugin<Project> {
    ...
    override fun apply(target: Project): Unit = with(target) {
        ...
        plugins {
            apply(libs.plugins.google.protobuf)
        }
        ...
        dependencies {
            implementation(libs.getLibrary("google.protobuf.java"))
            implementation(libs.getLibrary("google.protobuf.kotlin"))
        }
    }
}