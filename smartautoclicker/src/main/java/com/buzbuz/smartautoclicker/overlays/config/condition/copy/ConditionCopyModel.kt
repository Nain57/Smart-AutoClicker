...
class ConditionCopyModel(application: Application) : CopyViewModel<Condition>(application) {
    ...
    private fun getAllItems(dbConditions: List<Condition>, eventConditions: List<Condition>): List<ConditionCopyItem> {
        ...
        if (eventItems.isNotEmpty()) {
            allItems.add(ConditionCopyItem.HeaderItem(R.string.dialog_action_copy_header_event))
        ...
        if (conditions.isNotEmpty()) {
            allItems.add(ConditionCopyItem.HeaderItem(R.string.dialog_action_copy_header_all))
