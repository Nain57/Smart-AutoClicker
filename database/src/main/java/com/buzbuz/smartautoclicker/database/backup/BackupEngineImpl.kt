...
import com.buzbuz.smartautoclicker.database.backup.ext.readEntryFile
import com.buzbuz.smartautoclicker.database.backup.ext.writeEntryFile
...
internal class BackupEngineImpl(
     ...
     */
    private val conditionUnzipMatchRegex = """[0-9]+/${BitmapManagerImpl.CLICK_CONDITION_FILE_PREFIX}-?[0-9]+"""
        .toRegex()
