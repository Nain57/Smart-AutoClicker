...
class EventCopyAdapter(
    ...
    override fun getItemViewType(position: Int): Int =
        when(getItem(position)) {
            ...
            is EventCopyItem.EventItem.Image -> R.layout.item_screen_event
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
        when (viewType) {
            ...
            R.layout.item_screen_event -> ImageEventViewHolder(
...
class ImageEventViewHolder(private val viewBinding: ItemScreenEventBinding) : RecyclerView.ViewHolder(viewBinding.root) {
