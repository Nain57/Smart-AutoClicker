...
/**
 * Bind the [ItemScreenEventBinding] to an event.
 *
 * @param item the event represented by this view binding.
 * @param startBtnVisible true to show the start button, false to hide it.
 * @param itemClickedListener called when the user clicks on the item.
 */
fun ItemScreenEventBinding.bind(
    item: UiImageEvent,
    ...
    btnStart.visibility = if (startBtnVisible) View.VISIBLE else View.GONE
