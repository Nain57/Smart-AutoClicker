...
class TextConditionDialog(
    ...
    private val viewModel: TextConditionDialogViewModel by viewModels(
    ...
    override fun onCreateView(): ViewGroup {
        viewBinding = DialogConfigConditionTextBinding.inflate(LayoutInflater.from(context)).apply {
            ...
            fieldSelectLanguage.apply {
                setTitle(context.getString(R.string.field_condition_text_language_title))
    ...
    override fun onDialogCreated(dialog: BottomSheetDialog) {
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch { viewModel.textToDetect.collect(::updateConditionTextToDetect) }
                launch { viewModel.textToDetectError.collect(viewBinding.fieldEditConditionText::setError) }
                launch { viewModel.textLanguage.collect(::updateConditionLanguage) }
    ...
    private fun updateConditionTextToDetect(newTextToDetect: String?) {
        viewBinding.fieldEditConditionText.setText(newTextToDetect)
    }

    private fun updateConditionLanguage(newLanguagesChoice: TextLanguagesChoice) {
        viewBinding.fieldSelectLanguage.setDescription(
            context.getString(newLanguagesChoice.title)
        )
    }
    ...
    private fun showLanguageSelectionDialog() {
        overlayManager.navigateTo(
            ...
            newOverlay = MultiChoiceDialog(
                ...
                dialogTitleText = R.string.language_title,
                choices = allTextLanguagesChoices(),
                onChoiceSelected = viewModel::setTextLanguage,
            ),
            hideCurrent = true,
        )
    }
