 ...
 * @param eventConditionOperator the condition operator for this Event.
 ...
 * @param detectionResults the results for the conditions in this event.
 */
data class EventResultUiState(
    @field:DrawableRes val eventIcon: Int,
    val eventName: String,
    val eventFulfilled: Boolean,
...
data class TryEventActionsItem(
