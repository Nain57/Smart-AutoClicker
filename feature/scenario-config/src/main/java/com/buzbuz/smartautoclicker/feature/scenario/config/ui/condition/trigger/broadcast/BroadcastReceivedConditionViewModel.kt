 ...
 */
package com.buzbuz.smartautoclicker.feature.scenario.config.ui.condition.trigger.broadcast
...
class BroadcastReceivedConditionViewModel(application: Application) : AndroidViewModel(application) {
