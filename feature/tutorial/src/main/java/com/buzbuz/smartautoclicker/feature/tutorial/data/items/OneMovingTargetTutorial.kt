...
import com.buzbuz.smartautoclicker.feature.tutorial.data.subject.game.OneMovingTargetRules

internal fun getOneMovingTargetTutorialInfo(): TutorialInfo =
    TutorialInfo(
        id = TutorialType.IMAGE_DETECTION_MOVING_TARGET.name,
        nameResId = R.string.item_title_tutorial_2,
        descResId = R.string.item_desc_tutorial_2,
    )

internal fun newOneMovingTargetTutorial(): Tutorial =
    Tutorial(
        info = getOneMovingTargetTutorialInfo(),
