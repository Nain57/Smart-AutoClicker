...
object CombineConditionsOperatorOrTutorial : TutorialItem {

    override fun getType(): TutorialItem.Type =
        TutorialItem.Type.COMBINE_CONDITIONS_OPERATOR_OR

    override fun getTutorialInfo(): TutorialInfo =
        TutorialInfo(
            id = getType().toTutorialId(),
            nameResId = R.string.item_title_tutorial_combine_conditions_operator_or,
            descResId = R.string.item_desc_tutorial_combine_conditions_operator_or,
        )
        ...
        Tutorial(
            ...
            steps = listOf(
                ...
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_1,
                    stepStartCondition = TutorialStepStartCondition.Immediate,
                ...
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_2,
                    stepStartCondition = TutorialStepStartCondition.Immediate,
                ...
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_3,
                ...
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_4,
                    stepStartCondition = TutorialStepStartCondition.MonitoredOverlayDisplayed(
                ...
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_5,
                    stepStartCondition = TutorialStepStartCondition.MonitoredOverlayDisplayed(
                        MonitoredOverlayType.SCREEN_CONDITIONS_BRIEF_MENU
                    ),
                    stepEndCondition = TutorialStepEndCondition.MonitoredViewClicked(
                ...
                // Image condition dialog: Save red target condition and go back to condition list
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_6,
                    stepStartCondition = TutorialStepStartCondition.MonitoredOverlayDisplayed(
                        MonitoredOverlayType.IMAGE_CONDITION,
                    ),
                    stepEndCondition = TutorialStepEndCondition.MonitoredViewClicked(
                ...
                // ScreenCondition List: Note about OR and Condition priority. Ask for reorder red before blue
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_7,
                    stepStartCondition = TutorialStepStartCondition.MonitoredOverlayDisplayed(
                        MonitoredOverlayType.SCREEN_CONDITIONS_BRIEF_MENU,
                    ),
                    stepEndCondition = TutorialStepEndCondition.NextButton,
                ...
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_8,
                    stepStartCondition = TutorialStepStartCondition.MonitoredOverlayDisplayed(
                        MonitoredOverlayType.EVENT,
                    ),
                    stepEndCondition = TutorialStepEndCondition.MonitoredViewClicked(
                        MonitoredViewType.EVENT_DIALOG_FIELD_OPERATOR_ITEM_OR
                    ),
                ),
                // Event dialog: open actions list and create new click
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_9,
                    stepStartCondition = TutorialStepStartCondition.Immediate,
                    stepEndCondition = TutorialStepEndCondition.MonitoredViewClicked(
                        MonitoredViewType.EVENT_DIALOG_FIELD_ACTIONS,
                    ),
                ),
                // Click Dialog: Select "click on condition". As the condition is OR, click on detected nothing to select
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_10,
                    stepStartCondition = TutorialStepStartCondition.MonitoredOverlayDisplayed(
                ...
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_11,
                    stepStartCondition = TutorialStepStartCondition.MonitoredOverlayDisplayed(
                ...
                // Game won
                TutorialStep.TutorialOverlay(
                    contentTextResId = R.string.message_tutorial_combine_conditions_operator_or_step_12,
