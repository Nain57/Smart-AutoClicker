...
internal fun getEventsPrioritySlideshow() =
    TutorialSlideshow(
        type = TutorialSlideshow.Type.EVENTS_PRIORITY_BASICS,
        nameRes = R.string.tutorial_slideshow_events_priority_title,
        ...
        slideshowItems = listOf(
            ...
            TutorialSlideshow.SlideshowItem(
                tutorialTextRes = R.string.tutorial_slideshow_events_priority_step_2_text,
                tutorialImage = R.drawable.tutorial_instructions_keep_executing,
                tutorialImageFormat = TutorialSlideshow.ImageFormat.IMAGE_LARGE,
            ),
        ),
    )
