...
import com.buzbuz.smartautoclicker.feature.tutorial.data.subject.game.TwoStillTargetsPressWhenOneVisibleRules

internal fun getTwoStillTargetsPressWhenOneVisibleTutorialInfo(): TutorialInfo =
    TutorialInfo(
        id = TutorialType.IMAGE_DETECTION_TWO_STILL_TARGETS_PRESS_WHEN_ONE.name,
        nameResId = R.string.item_title_tutorial_4,
        descResId = R.string.item_desc_tutorial_4,
    )

internal fun newTwoStillTargetsPressWhenOneVisibleTutorial(): Tutorial =
    Tutorial(
        info = getTwoStillTargetsPressWhenOneVisibleTutorialInfo(),
