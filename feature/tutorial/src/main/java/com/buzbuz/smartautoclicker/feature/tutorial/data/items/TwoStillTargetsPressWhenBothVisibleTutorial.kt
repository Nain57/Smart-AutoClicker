...
import com.buzbuz.smartautoclicker.feature.tutorial.data.subject.game.TwoStillTargetsPressWhenBothVisibleRules

internal fun getTwoStillTargetsPressWhenBothVisibleTutorialInfo(): TutorialInfo =
    TutorialInfo(
        id = TutorialType.IMAGE_DETECTION_TWO_STILL_TARGETS_PRESS_WHEN_BOTH.name,
        nameResId = R.string.item_title_tutorial_3,
        descResId = R.string.item_desc_tutorial_3,
    )

internal fun newTwoStillTargetsPressWhenBothVisibleTutorial(): Tutorial =
    Tutorial(
        info = getTwoStillTargetsPressWhenBothVisibleTutorialInfo(),
