...
internal fun getWriteTextActionCategory() =
    TutorialCategory(
        type = TutorialCategory.Type.WRITE_TEXT_ACTION,
        nameRes = R.string.tutorial_category_write_text_action_name,
        shortDescriptionRes = R.string.tutorial_category_write_text_action_desc_short,
