...
internal fun getSwipeActionCategory() =
    TutorialCategory(
        type = TutorialCategory.Type.SWIPE_ACTION,
        nameRes = R.string.tutorial_category_swipe_action_name,
        shortDescriptionRes = R.string.tutorial_category_swipe_action_desc_short,
