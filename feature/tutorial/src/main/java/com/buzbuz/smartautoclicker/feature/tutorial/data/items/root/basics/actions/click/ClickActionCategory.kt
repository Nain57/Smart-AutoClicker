...
internal fun getClickActionCategory() =
    TutorialCategory(
        type = TutorialCategory.Type.CLICK_ACTION,
        nameRes = R.string.tutorial_category_click_action_name,
        shortDescriptionRes = R.string.tutorial_category_click_action_desc_short,
