...
internal fun getChangeEventStateActionSlideshow() =
    TutorialSlideshow(
        type = TutorialSlideshow.Type.TOGGLE_EVENT_ACTION,
        nameRes = R.string.tutorial_slideshow_toggle_event_action_title,
        shortDescriptionRes = R.string.tutorial_slideshow_toggle_event_action_desc,
