...
internal fun getNotificationActionCategory() =
    TutorialCategory(
        type = TutorialCategory.Type.NOTIFICATION_ACTION,
        nameRes = R.string.tutorial_category_notification_action_name,
        shortDescriptionRes = R.string.tutorial_category_notification_action_desc_short,
