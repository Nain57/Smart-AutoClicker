...
internal fun getSystemActionCategory() =
    TutorialCategory(
        type = TutorialCategory.Type.SYSTEM_ACTION,
        nameRes = R.string.tutorial_category_system_action_name,
        shortDescriptionRes = R.string.tutorial_category_system_action_desc_short,
