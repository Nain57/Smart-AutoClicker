...
internal fun getIntentActionCategory() =
    TutorialCategory(
        type = TutorialCategory.Type.INTENT_ACTION,
        nameRes = R.string.tutorial_category_intent_action_name,
        shortDescriptionRes = R.string.tutorial_category_intent_action_desc_short,
