...
#ifndef KLICK_R_COLOR_MATCHING_RESULT_HPP
#define KLICK_R_COLOR_MATCHING_RESULT_HPP
...
namespace smartautoclicker {
    ...
    class ColorMatchingResult: public DetectionResult {
    private:
        bool detected;
        int centerX;
        int centerY;
        cv::Rect area;
        double colorDiffResult;

    public:
        void updateResults(const cv::Rect& detectionArea, double diffResult);
...
#endif //KLICK_R_COLOR_MATCHING_RESULT_HPP
