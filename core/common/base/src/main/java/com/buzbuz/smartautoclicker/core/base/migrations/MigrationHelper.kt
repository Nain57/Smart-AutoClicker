...
inline fun <reified A : Any> SQLiteTable.forEachRow(
    ...
    select(extraClause, distinct, columnA).use { queryResult -> queryResult.forEachRow { row -> closure(row.getValue(columnA)) } }
...
inline fun <reified A : Any, reified B : Any> SQLiteTable.forEachRow(
    ...
    select(extraClause, distinct, columnA, columnB).use { queryResult ->
...
inline fun <reified A : Any, reified B : Any, reified C : Any> SQLiteTable.forEachRow(
    ...
    select(extraClause, distinct, columnA, columnB, columnC).use { queryResult ->
...
inline fun <reified A : Any, reified B : Any, reified C : Any, reified D : Any> SQLiteTable.forEachRow(
    ...
    select(extraClause, distinct, columnA, columnB, columnC, columnD).use { queryResult ->
