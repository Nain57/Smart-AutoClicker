...
/**
 * Strategy interface for a [TutorialSubject.QuickCountGame]'s gameplay logic.
 *
 ...
 *
 * All returned maps use [QuickClickGameTargetType] as the key and a normalized [PointF]
...
interface QuickClickGameRules {
     ...
     */
    fun onStart(): Map<QuickClickGameTargetType, QuickClickGameTargetState>
