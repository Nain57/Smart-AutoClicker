...
interface TutorialNavigator {
    ...
    fun showTipDialog(context: Context, tip: Tip, onDismissed: (() -> Unit)? = null)

}

fun Context.getTutorialNavigator(): TutorialNavigator =
    EntryPoints
        .get(applicationContext, NavigationEntryPoint::class.java)
        .tutorialNavigator()
