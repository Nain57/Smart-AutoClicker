...
fun IncludeFieldDataDisplayBinding.setTitle(titleText: String) {
    titleAndDescription.setTitle(titleText)
}

fun IncludeFieldDataDisplayBinding.setupDescriptions(descriptions: List<String>) {
    titleAndDescription.setupDescriptions(descriptions)
}

fun IncludeFieldDataDisplayBinding.setDescription(descriptionIndex: Int) {
    titleAndDescription.setDescription(descriptionIndex)
}

fun IncludeFieldDataDisplayBinding.setDescription(description: String?) {
    titleAndDescription.setDescription(description)
}

fun IncludeFieldDataDisplayBinding.setIconBitmap(bitmap: Bitmap?) {
    icon.visibility = if (bitmap == null) View.GONE else View.VISIBLE
    icon.setImageBitmap(bitmap)
}

fun IncludeFieldDataDisplayBinding.setImageDrawable(drawable: Drawable?) {
